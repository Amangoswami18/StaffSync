  ...
  return (
    <div className="flex h-screen w-screen items-center justify-center bg-gradient-to-br from-[#0d0d0d] via-[#121212] to-[#1a1a1a] px-4">
      ...
      >
        ...
        <div className="mb-6 p-4 rounded-xl border border-emerald-600 bg-[#121212] text-emerald-300 text-sm">
          <h3 className="text-lg font-semibold text-emerald-400 mb-2">🔑 Demo Credentials</h3>
          <p><span className="font-medium">Admin:</span> <code className="text-white">admin@me.com</code> / <code className="text-white">12345</code></p>
          <p><span className="font-medium">Employee:</span> <code className="text-white">emp@A.com</code> / <code className="text-white">123</code></p>
          <p className="text-xs text-gray-400 mt-2">Use for testing/demo purpose only</p>
        </div>
